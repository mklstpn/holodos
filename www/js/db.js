...
function updateProducts (transaction, results) {
    ...
    var listitems = "";
    //get the product list holder ul
...
function outputProducts() {
    ...
    if (mydb) {
        //Get all the products from the database with a select statement, set outputProducts as the callback function for the executeSql command
        mydb.transaction(function (t) {
...
function addProduct() {
    ...
    if (mydb) {
        ...
        //Test to ensure that the user has entered all values
